...
public class TransferListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TransferListAdapter.TransferListAdapterListener onClickListener;

    public TransferListAdapter(Context context, List<ActiveUserList> userList,TransferListAdapterListener listener) {
    ...
    public interface TransferListAdapterListener {
