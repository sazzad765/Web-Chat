...
public class UserPurchaseListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    List<PurchaseList.Purchase> purchase;
    public UserPurchaseListAdapterListener onClickListener;
    private static final int LOADING = 0;
    private static final int ITEM = 1;
    private boolean isLoadingAdded = false;
    public UserPurchaseListAdapter(Context context, List<PurchaseList.Purchase> purchase, UserPurchaseListAdapterListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case ITEM:
                ...
                viewHolder = new UserPurchaseListAdapter.ItemViewHolder(viewItem);
                break;
            case LOADING:
                View viewLoading = inflater.inflate(R.layout.item_progress, parent, false);
                viewHolder = new UserPurchaseListAdapter.LoadingViewHolder(viewLoading);
                break;
        }
        return viewHolder;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        switch (getItemViewType(position)) {
            case ITEM:
                UserPurchaseListAdapter.ItemViewHolder viewHolder = (UserPurchaseListAdapter.ItemViewHolder) holder;
...
//                        .into(viewHolder.imageProduct);
            ...
            case LOADING:
                UserPurchaseListAdapter.LoadingViewHolder loadingViewHolder = (UserPurchaseListAdapter.LoadingViewHolder) holder;
    ...
    public interface UserPurchaseListAdapterListener {
